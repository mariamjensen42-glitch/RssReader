...
export const FlatButtonGroup: React.FC<FlatButtonGroupProps> = ({ children, styleClass }) => {
    const classes = useStyles()
    const focusAttrs = useArrowNavigationGroup({ axis: "horizontal" })
    return <div className={mergeClasses(classes.root, styleClass)} {...focusAttrs}>{children}</div>
}
